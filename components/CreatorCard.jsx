...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorEths }) => (
  <div className="min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-white dark:border-nft-black border-nft-gray-2 rounded-3xl flex flex-col p-4 m-4 shadow-md">
    <div className="w-8 h-8 minglg:w-10 minlg:h-10 bg-nft-red-violet flexCenter rounded-full">
